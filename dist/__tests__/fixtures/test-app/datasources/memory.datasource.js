...
MemoryDataSource.dataSourceName = 'db';
MemoryDataSource.defaultConfig = config;
exports.MemoryDataSource = MemoryDataSource = __decorate([
    __param(0, (0, core_1.inject)('datasources.config.memory', { optional: true }))
], MemoryDataSource);
